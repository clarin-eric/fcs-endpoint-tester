...
public class TestExplain6 extends FCSTest {
    ...
    public String getExpected() {
        return "Expecting exactly one valid FCS endpoint decription conforming to FCS 1.0 spec";
    }
    ...
    private FCSTestResult validate(FCSTestContext context, ClarinFCSEndpointDescription desc) {
        if (desc.getVersion() == 1) {
            ...
            return makeError("FCS 1.0 endpoint must provide an endpoint description with version set to \"1\"");
        }
    }
