...
public class TestSearch6 extends FCSTest {
    ...
    public String getDescription() {
        return "Search with invalid value of 0 for 'startRecord' argument";
    }
    ...
    public FCSTestResult perform(FCSTestContext context, SRUSimpleClient client,
        ...
        req.setExtraRequestData(
                SRUSearchRetrieveRequest.X_MALFORMED_START_RECORD, "0");
