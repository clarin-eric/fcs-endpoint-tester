...
public class TestSearch9 extends FCSTest {
    ...
    public String getDescription() {
        return "Search with invalid query";
    }


    @Override
    public String getExpected() {
        return "Expecting diagnostic \"info:srw/diagnostic/1/10\"";
    }
    ...
    public FCSTestResult perform(FCSTestContext context, SRUSimpleClient client,
        ...
        return handler.findDiagnostic("info:srw/diagnostic/1/10")
                ? makeSuccess()
                : makeErrorNoDiagnostic("info:srw/diagnostic/1/10");
    }
