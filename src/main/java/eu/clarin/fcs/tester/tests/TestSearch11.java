...
public class TestSearch11 extends FCSTest {
    ...
    public String getDescription() {
        return "Search for string with non-ASCII characters encoded as UTF-8";
    }


    @Override
    public String getExpected() {
        return "No errors or diagnostics (and zero or more records)";
    }
