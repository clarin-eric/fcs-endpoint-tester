...
public class TestSearch5 extends FCSTest {
    ...
    public String getDescription() {
        return "Search with invalid value for 'startRecord' argument";
    }
    ...
    public FCSTestResult perform(FCSTestContext context, SRUSimpleClient client,
        ...
        req.setExtraRequestData(
                SRUSearchRetrieveRequest.X_MALFORMED_START_RECORD, "invalid");
        client.searchRetrieve(req, handler);
        return handler.findDiagnostic("info:srw/diagnostic/1/6")
                ? makeSuccess()
