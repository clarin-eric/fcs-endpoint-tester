...
@SRUTestCase(priority=2050)
public class TestScan5 implements SRUTest {
    ...
    public String getDescription() {
        return "CLARIN-FCS: scan on 'fcs.resource = root' with bad 'responsePosition' argument (expecting diagnostic \"info:srw/diagnostic/1/6\")";
    }
