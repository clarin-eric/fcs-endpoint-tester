...
@SRUTestCase(priority=3080)
public class TestSearch8 implements SRUTest {
    ...
    public String getDescription() {
        return "Search with invalid value of -1 for 'maximumRecords' argument (expecting diagnostic \"info:srw/diagnostic/1/6\")";
    }
