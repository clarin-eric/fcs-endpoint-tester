...
@SRUTestCase(priority=3050)
public class TestSearch5 implements SRUTest {
    ...
    public String getDescription() {
        return "Search with invalid value for 'startRecord' argument (expecting diagnostic \"info:srw/diagnostic/1/6\")";
    }
