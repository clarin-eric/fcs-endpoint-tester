...
@SRUTestCase(priority=3100)
public class TestSearch10 implements SRUTest {
    ...
    public String getDescription() {
        return "Search to provoke first record position out of range diagnostic (expecting diagnostic \"info:srw/diagnostic/1/61\")";
    }
    ...
    public Result performTest(SRUSimpleClient client,
        ...
        return handler.findDiagnostic("info:srw/diagnostic/1/61") ? SUCCESS : ERROR_NO_DIAGNOSTIC;
    }
